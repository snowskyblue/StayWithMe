...
<div class="main">
	<div class="container" id="csA-header">
		...
		<div class="csBoard mx-auto">
			<form method="POST" action="csModifyPro">
				...
				<div class="mx-auto" id="cs_contents">
					...
					<div align="right">
						...
						<button type="button" id="cs_goListBtn" onClick="location.href='csAdmin'" class="btn btn-dark" style="margin-top:10px;">목록</button>
					</div>
				</div>
			</form>
		</div>
